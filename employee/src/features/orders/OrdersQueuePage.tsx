      ...
      <Panel>
        ...
        {rows.length > 0 ? (
          <div className={orders.isFetching ? "table-wrap busy" : "table-wrap"}>
            <table>
              <thead>
                {/* Same columns as `admin/`'s queue, reordered for the phone
                    this actually runs on: status and time sit where they are
                    readable without scrolling sideways, and the phone number —
                    a tappable link on the detail screen — goes last. */}
                <tr>
                  <th>#</th>
                  <th>Cliente</th>
                  <th>Estado</th>
